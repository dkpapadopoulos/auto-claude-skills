...
| A3 | Analogous fix worked for onboarding flow | capability | H | direct_observation | docs/CI.md#THIS_LITERAL_DOES_NOT_EXIST_XYZZY | 2026-07-05 | B | pilot conversion <2% -> kill |
