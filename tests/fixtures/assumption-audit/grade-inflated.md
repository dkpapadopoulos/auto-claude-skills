...
| A2 | Competitors will not match pricing | competitor | M | expert_judgment | PM interview | 2026-07-08 | A | untested (cutoff) |
| A3 | Analogous fix worked for onboarding flow | capability | H | analogous | docs/CI.md#Required | 2026-07-05 | C | pilot conversion <2% -> kill |
