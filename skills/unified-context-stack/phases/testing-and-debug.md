...
- **lsp=false and serena=true** (compile/type errors): Use `mcp__serena__get_diagnostics_for_file` or `mcp__serena__get_diagnostics_for_symbol` — Serena v1.3.0+ — as a fallback authoritative source
